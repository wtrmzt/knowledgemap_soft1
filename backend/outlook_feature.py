...
def _generate_concept_detail(subject_name: str, target_label: str, target_sentence: str,
    ...
    system = (
        "あなたは大学の学習支援AIです。学生がまだ学んでいない概念について、"
        "前提知識がなくても理解できるよう、次の構成で日本語で説明してください:\n"
        "(1) 一言でいうと何か (2) 身近な例やたとえ (3) 学生が今学んでいる概念との関係。\n"
        "全体で250字以内。専門用語を使う場合は必ず言い換えを添えてください。\n"
        '出力は次のJSON形式のみ: {"detail": "..."}'
    )
    user = json.dumps({
